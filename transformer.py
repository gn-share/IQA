...
#         self.position_embeddings = nn.Embedding(max_position_embeddings,width)

#     def forward(self,x):
#         seq_length = x.size(1)
#         positions = torch.arange(seq_length,dtype=torch.long)
#         position_embeddings = self.position_embeddings(positions)
#         positions_broadcast_shape = [1]*(x.dim()-2)+[seq_length,x.size(-1)]
#         position_embeddings = position_embeddings.view(*positions_broadcast_shape)
